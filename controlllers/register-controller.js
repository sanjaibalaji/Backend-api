...
exports.register = async (req, res, next) => {
  ...
  const mailOptions = {
    ...
    html: `Please click <a href="https://odooformybusiness.com/create_password?verificationToken=${verificationToken}">here</a> to verify your email address.`
  };
...
exports.forgotPassword = async (req, res, next) => {
  ...
  const mailOptions = {
    ...
    html: `Please click <a href="https://odooformybusiness.com/reset_password?verificationToken=${verificationToken}">here</a> to verify your email address.`
  };
  const mail = await transporter.sendMail(mailOptions);
  if (mail.accepted.length) {
